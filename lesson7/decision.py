...
- Include Source and ID in FINAL_ANSWER
...
✅ Examples:
- User asks: "Lady Gaga Concert"
  - FUNCTION_CALL: search_documents|query="Lady Gaga"
  - [receives a detailed document]
  - FINAL_ANSWER: [https://text.npr.org/nx-s1-5386457]
